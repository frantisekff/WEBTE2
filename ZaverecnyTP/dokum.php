...
<nav class="navbar navbar-expand-sm bg-dark">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="dokum.php"> Dokumentacia</a>
        </li>
    </ul>
</nav>
...
<div class="row">
    ...
    <div class="col-md-4 offset-4 " style="word-wrap: break-word;">
        ...
        <br>
        <strong>Administrátorské meno je admin@admin.admin a heslo .</strong>
        <br>
        <strong>Užívateľsky účet meno: frantisek.ff.ff@gmail.com a heslo </strong>
        <br>
        Projekt sa nachádza na adrese: https://147.175.98.137/final
        <br>Prihlásiť sa môžeme v sekcii login a zaregistrovať s mailom v sekcii sign up.
        <br> <br>
        <h2>Bežný užívateľ:</h2>
        ...
        <br>Vladimír Ďurčík a Michal Firča - úlohy 1. - 5.
        <br>Richard Szabo a Richard Friedl - úlohy 6. - 10.
        <br>František Franko - úlohy 11. - 13.
